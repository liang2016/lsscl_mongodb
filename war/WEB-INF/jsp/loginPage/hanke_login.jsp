...
<table width="100%"  cellspacing="0" cellpadding="0" border="0">
	<tr  style="background-color: #6ba53a">
		<td colspan="3" align="left"><img alt="kpsLogo" src="logos/whrite.png"></img> </td>
	</tr>
	<tr>
		<td align="right" style="background-color: #6ba53a;width:30%;" height="84px"><b><span style="color:#ffffff;font-size: 30px;">&nbsp;&nbsp;&nbsp;</span></b></td>
...
<center>
        <form  action="hanke_login.htm" id="loginForm" method="post"  onSubmit="return true" >
          <table align="center">
...
<table align="center">
   ...
   <tr>
   	<td align="center" height="60px"><span style="color: #006400;font-size: 18px; padding: 10px;" ></span></td>
   </tr>
</table>
</body>  
</tag:page>