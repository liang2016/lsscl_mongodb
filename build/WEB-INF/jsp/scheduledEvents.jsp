...
<tag:page dwr="ScheduledEventsDwr" onload="init">
  <script type="text/javascript">
    ...
    function init() {
        ...
        ScheduledEventsDwr.getScheduledEvents(${sessionUser.currentScope.id},initCB);
    }
    ...
    function setTime(){
       var hours=$get("setTime");
       var reg = new RegExp("^[0-9]*$");
  	   if(!reg.test(hours)){
         alert("<fmt:message key="badIntegerFormat"/>");
         return;
   	  }
    	ScheduledEventsDwr.setStartTime(hours,setCB);
    }
    function setCB(se){
    ...
    function saveScheduledEvent() {
        ...
        ScheduledEventsDwr.saveScheduledEvent(editingScheduledEvent.id, $get("xid"), $get("alias"), $get("alarmLevel"), 
                ...
                $get("inactiveMinute"), $get("inactiveSecond"), $get("inactiveCron"),$get("scopeId"), function(response) {
        ...
        <div class="borderDiv">
          ...
          <table>
            <tr>
              ...
              <td class="formField"><input type="text" id="xid"/><input type="hidden" id="scopeId" value="${sessionUser.currentScope.id}"></td>
            ...
            <tr id="setTimeTr">
            	<td class="formLabelRequired"><fmt:message key="scheduledEvents.setTime"/></td>
            	<td class="formField">
            		<input type="text" id="setTime"><input type="button" value="<fmt:message key="scheduledEvents.set"/>" onclick="setTime()">
            	</td>
            </tr>
