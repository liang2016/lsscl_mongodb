 ...
 *{font-family:Arial, Helvetica, sans-serif;font-size:14px;border:none;}
 ...
 #table td{width:100px;height:24px;text-align:center;line-height:24px;border:1px solid silver;}
 .red{color:red;}
...
<h2><fmt:message key="app.appUsers"/></h2>
<table cellpadding="0" id="table">
 <tr class="top">
 	<td><fmt:message key="app.phoneno"/></td>
 	<td><fmt:message key="app.username"/></td>
 	<td><fmt:message key="app.lastLoginTime"/></td>
 	<td><fmt:message key="app.loginTime"/></td>
 	<td><fmt:message key="app.lastRspTime"/></td>
 	<td><fmt:message key="app.scopeId"/></td>
 	<td><fmt:message key="app.scopeName"/></td>
 	<td><fmt:message key="app.isOnline"/></td>
 	<td><fmt:message key="app.deviceType"/></td>
 	<td><fmt:message key="app.token"/></td>
 ...
 <c:forEach items="${users}" var="p">
  <tr>
   ...
   <td>
    <c:choose>
		<c:when test="${p.online}">
			<fmt:message key="app.online"/>
		</c:when>
		<c:otherwise>
			<fmt:message key="app.offline"/>
		</c:otherwise>
		</c:choose>
   </td>
