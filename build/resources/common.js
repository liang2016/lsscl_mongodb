...
function setDateRangeForNoCheck(data) {
    $set("fromYear", data.fromYear);
    $set("fromMonth", data.fromMonth);
    $set("fromDay", data.fromDay);
    $set("fromHour", data.fromHour);
...
function setDateRangeS(data) {
    $set("fromYearS", data.fromYear);
    $set("fromMonthS", data.fromMonth);
    $set("fromDayS", data.fromDay);
    $set("fromHourS", data.fromHour);
    $set("fromMinuteS", data.fromMinute);
    $set("fromSecondS", data.fromSecond);
    
    $set("toYearS", data.toYear);
    $set("toMonthS", data.toMonth);
    $set("toDayS", data.toDay);
    $set("toHourS", data.toHour);
    $set("toMinuteS", data.toMinute);
    $set("toSecondS", data.toSecond);
    updateDateRangeS();
}

function updateDateRangeS() {
    var inception = $get("fromNoneS");
    setDisabled("fromYearS", inception);
    setDisabled("fromMonthS", inception);
    setDisabled("fromDayS", inception);
    setDisabled("fromHourS", inception);
    setDisabled("fromMinuteS", inception);
    setDisabled("fromSecondS", inception);
    setDisabled("fromNoneS", false);
    
    var now = $get("toNoneS");
    setDisabled("toYearS", now);
    setDisabled("toMonthS", now);
    setDisabled("toDayS", now);
    setDisabled("toHourS", now);
    setDisabled("toMinuteS", now);
    setDisabled("toSecondS", now);
    setDisabled("toNoneS", false);
}

function setDateRangeC(data) {
    $set("fromYearC", data.fromYear);
    $set("fromMonthC", data.fromMonth);
    $set("fromDayC", data.fromDay);
    $set("fromHourC", data.fromHour);
    $set("fromMinuteC", data.fromMinute);
    $set("fromSecondC", data.fromSecond);
    
    $set("toYearC", data.toYear);
    $set("toMonthC", data.toMonth);
    $set("toDayC", data.toDay);
    $set("toHourC", data.toHour);
    $set("toMinuteC", data.toMinute);
    $set("toSecondC", data.toSecond);
    updateDateRangeC();
}

function updateDateRangeC() {
    var inception = $get("fromNoneC");
    setDisabled("fromYearC", inception);
    setDisabled("fromMonthC", inception);
    setDisabled("fromDayC", inception);
    setDisabled("fromHourC", inception);
    setDisabled("fromMinuteC", inception);
    setDisabled("fromSecondC", inception);
    setDisabled("fromNoneC", false);
    
    var now = $get("toNoneC");
    setDisabled("toYearC", now);
    setDisabled("toMonthC", now);
    setDisabled("toDayC", now);
    setDisabled("toHourC", now);
    setDisabled("toMinuteC", now);
    setDisabled("toSecondC", now);
    setDisabled("toNoneC", false);
}
