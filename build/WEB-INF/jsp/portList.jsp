...
<h2>Port Query</h2>
<form action="/portList.shtm" method="post">
    	DataSourceName:<input type="text" name="name"/><br/>
...
<form action="/portList.shtm" method="post" id="form">
...
<a href="javascript:toPage(${query.page-1})">prev</a> <span>${query.page}</span>/<span>${query.totalPage}</span> <a href="javascript:toPage(${query.page+1})">next</a>
<script type="text/javascript">
