...
<tag:page dwr="PointLinksDwr" onload="init">
  <script type="text/javascript">
    ...
    function init() {
        PointLinksDwr.init($get("factoryId"),function(response) {
    ...
    function savePointLink() {
        ...
        PointLinksDwr.savePointLink(editingPointLink.id, $get("xid"), $get("sourcePointId"), $get("targetPointId"),
                $get("script"), $get("event"), $get("disabled"),$get("scopeId"), function(response) {
          ...
          <table width="100%">
            <tr>
              <td>
                ...
                <input type="hidden" id="factoryId" value="${sessionUser.currentScope.id}">
