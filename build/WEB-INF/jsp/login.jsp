...
<table width="100%"  cellspacing="0" cellpadding="0" border="0px #6ba53a solid" >
	<tr  style="background-color: #6ba53a">
		<td colspan="3" height="100px"></td>
	</tr>
	<tr>
		<td style="background-color: #6ba53a" height="84px">&nbsp;</td>
		<td align="center" rowspan="2" style="width: 449px;height: 120px">
...
<form  action="login.htm" id="loginForm" method="post"  onSubmit="return true" >
	<center>
          <table align="center">
