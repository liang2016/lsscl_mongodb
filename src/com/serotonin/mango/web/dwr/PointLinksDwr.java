...
public class PointLinksDwr extends BaseDwr {
    public Map<String, Object> init(int factoryId) {
        User user = Common.getUser();
        Map<String, Object> data = new HashMap<String, Object>();

        // Get the points that this user can access.
        List<DataPointVO> allPoints = new DataPointDao().getDataPoints(factoryId,DataPointExtendedNameComparator.instance, false);
        ...
        for (PointLinkVO pointLink : new PointLinkDao().getPointLinks(user.getCurrentScope().getId())) {
    ...
    public DwrResponseI18n savePointLink(int id, String xid, int sourcePointId, int targetPointId, String script,
            int event, boolean disabled,int scopeId) {
