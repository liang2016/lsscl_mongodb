...
<div id="graphicRendererEditorPopup" style="display:none;left:0px;top:0px;" class="windowDiv">
  <table cellpadding="0" cellspacing="0"><tr><td>
    <table width="100%">
      <tr>
        <td>
          ...
          <span class="smallTitle" id="graphicsComponentName"></span>
        </td>
        <td align="right">
    ...
    <table>
      ...
      <tbody id="graphicRenderer_flashReport" style="display:none;">
      	<tr style="display:none;">
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.flashColor"/></td>
          <td class="formField"><input id="graphicRendererFlashReportflashflag" type="checkbox"/></td>
      	</tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.displayPointName"/></td>
          <td class="formField"><input id="graphicRendererFlashReportDisplayPointName" type="checkbox"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.min"/></td>
          <td class="formField"><input id="graphicRendererFlashReportMin" type="text"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.max"/></td>
          <td class="formField"><input id="graphicRendererFlashReportMax" type="text"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.flashColor"/></td>
          <td class="formField"><input id="graphicRendererFlashReportFlashColor" type="checkbox"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.linkURL"/></td>
          <td class="formField"><input id="graphicRendererFlashReportLinkUrl" type="text"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.compound.duration"/></td>
          <td class="formField">
            <input type="text" id="graphicRendererFlashReportDurationPeriods" class="formShort"/>
            <select id="graphicRendererFlashReportDurationType">
      ...
      <tbody id="graphicRenderer_flashSimple" style="display:none;">
      	<tr style="display:none;">
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.flashColor"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleflashflag" type="checkbox"/></td>
      	</tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.displayPointName"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleDisplayPointName" type="checkbox"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.min"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleMin" type="text"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.max"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleMax" type="text"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.flashColor"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleFlashColor" type="checkbox"/></td>
        </tr>
        <tr>
          <td class="formLabelRequired"><fmt:message key="viewEdit.graphic.styleAttribute"/></td>
          <td class="formField"><input id="graphicRendererFlashSimpleStyleAttribute" type="text"/></td>
        </tr>
      </tbody>
  ...
  <script type="text/javascript">
    ...
    function GraphicRendererEditor() {
        ...
        this.setViewComponent = function(comp) {
            ...
            $set("graphicRendererFlashSimpleflashflag");
            $set("graphicRendererFlashSimpleMin");
            $set("graphicRendererFlashSimpleMax");
            $set("graphicRendererFlashSimpleFlashColor");
            $set("graphicRendererFlashSimpleStyleAttribute");
            $set("graphicRendererFlashSimpleDisplayPointName");
            
            $set("graphicRendererFlashReportflashflag");
            $set("graphicRendererFlashReportMin");
            $set("graphicRendererFlashReportMax");
            $set("graphicRendererFlashReportFlashColor");
            $set("graphicRendererFlashReportDisplayPointName");
            $set("graphicRendererFlashReportDurationPeriods");
            $set("graphicRendererFlashReportDurationType");
            $set("graphicRendererFlashReportLinkUrl");
            
           // $set("graphicRendererSimpleDisplayPointName","checked");
           $("graphicRendererSimpleDisplayPointName").checked = true;
            ...
            }else if (comp.typeName == "flashSimple"){            	
                $set("graphicRendererFlashSimpleMin", comp.min);
                $set("graphicRendererFlashSimpleMax", comp.max);
                $set("graphicRendererFlashSimpleflashflag",comp.flashflag);
                $set("graphicRendererFlashSimpleFlashColor", comp.flashColor);
                $set("graphicRendererFlashSimpleDisplayPointName", comp.displayPointName);
                $set("graphicRendererFlashSimpleStyleAttribute", comp.styleAttribute);         
            ...
            }else if (comp.typeName == "flashReport"){
                $set("graphicRendererFlashReportMin", comp.min);
                $set("graphicRendererFlashReportMax", comp.max);
                $set("graphicRendererFlashReportflashflag",comp.flashflag);
                $set("graphicRendererFlashReportFlashColor", comp.flashColor);
                $set("graphicRendererFlashReportDisplayPointName", comp.displayPointName); 
                $set("graphicRendererFlashReportDurationPeriods", comp.durationPeriods);            	
                $set("graphicRendererFlashReportDurationType", comp.durationType);
                $set("graphicRendererFlashReportLinkUrl", comp.linkUrl);
            }
        ...
        this.save = function() {
            ...
            else if (graphicRendererEditor.typeName == "flashSimple")
            	ViewDwr.saveSimpleFlashPointComponent(
            			graphicRendererEditor.componentId,
            			$get("graphicRendererFlashSimpleMin"),
            			$get("graphicRendererFlashSimpleMax"),
            			$get("graphicRendererFlashSimpleflashflag"),
            			$get("graphicRendererFlashSimpleDisplayPointName"),
            			$get("graphicRendererFlashSimpleFlashColor"),
                        $get("graphicRendererFlashSimpleStyleAttribute"),
                        graphicRendererEditor.saveCB);
            else if (graphicRendererEditor.typeName == "flashReport") {
            	ViewDwr.saveFlashReportPointComponent(
            			graphicRendererEditor.componentId,
            			$get("graphicRendererFlashReportMin"),
            			$get("graphicRendererFlashReportMax"),
            			$get("graphicRendererFlashReportflashflag"),
            			$get("graphicRendererFlashReportDisplayPointName"),
            			$get("graphicRendererFlashReportFlashColor"), 
                		$get("graphicRendererFlashReportDurationPeriods"),           	
                		$get("graphicRendererFlashReportDurationType"),
                		$get("graphicRendererFlashReportLinkUrl"),
                        graphicRendererEditor.saveCB);
            }
