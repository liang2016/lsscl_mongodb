...
public class SystemSettingsDao extends BaseDao {
    ...
    public static final String EXCHANGE_DOMAIN = "exchangeDomain";
    ...
    public static boolean isExchange() {
    	String type=getValue(SystemSettingsDao.EMAIL_TYPE);
    	if(type=="exchange"||type.equals("exchange"))
    		return true;
    	else
    		return false;
	}
    ...
    static {
        ...
        DEFAULT_VALUES.put(EMAIL_FROM_NAME, "LssclM2M");
        ////exchange
        DEFAULT_VALUES.put(EXCHANGE_URL, "");
        DEFAULT_VALUES.put(EXCHANGE_USERNAME,"");
        DEFAULT_VALUES.put(EXCHANGE_PASSWORD, "");
        DEFAULT_VALUES.put(EXCHANGE_DOMAIN, "");

        DEFAULT_VALUES.put(EMAIL_TYPE, "");
        ...
        DEFAULT_VALUES.put(INSTANCE_DESCRIPTION, "My LssclM2M");
