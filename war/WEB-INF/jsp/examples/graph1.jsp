...
<script type="text/javascript" src="../plugins/dygraph-options-reference.js"></script>
    ...
    <div id="hello" class="hello"></div>
	  ...
	  //清空复选框
		  ...
		  function loadCheckedBox(){
		    ...
		    DynamicAndHistoryPointDwr.getPoints(selectWatchList,function(data){
	   ...
	   <script type="text/javascript">
		...
		function getDateBack(){
		       ...
		       //调用加载时的loading图片显示
		       dwrLoading('images/loading.gif');
		      // DynamicAndHistoryPointDwr.getDataSize(idxArray,fromYear,fromMonth,fromDay,fromHour,fromMinute,fromSecond,true,toYear,toMonth,toDay,toHour,toMinute,toSecond,true,dataSize);
     	   DynamicAndHistoryPointDwr.getPointHistoryData(idxArray,fromYear,fromMonth,fromDay,fromHour,fromMinute,fromSecond,toYear,toMonth,toDay,toHour,toMinute,toSecond,one,two,callBack);
		...
		DynamicAndHistoryPointDwr.getPointHistoryData(idxArray,fromYear,fromMonth,fromDay,fromHour,fromMinute,fromSecond,toYear,toMonth,toDay,toHour,toMinute,toSecond,0,200000,callBack);
	        $("showbl").innerHTML="响应前的时间为:"+new Date().getSeconds()+"" ;
	   

	  $("time").innerHTML+="<br>加载:"+new Date().getSeconds()+"";
		         ...
		         $("time").innerHTML+="<br>开始整合数组:"+new Date().getSeconds()+"";
			        while(1){
				        ...
				        graphDataArray.push(midArray);
			  	       ...
			  	       $("showbl").innerHTML="响应后的时间为:"+new Date().getSeconds()+"" ;
				   ...
				   g = new Dygraph(document.getElementById("div_g"), graphDataArray,
				    ...
				    $("time").innerHTML+="<br>开始查询:"+new Date().getSeconds()+"";
			   }//end getpoint
  ...
  <body onload="init()">
     ...
     <div id="info">
     <input type="button" value="取值" onclick="getInfo()" />
