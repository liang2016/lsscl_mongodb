...
<tag:page dwr="PointHierarchyDwr" onload="init">
  <script type="text/javascript">
    ...
    function init() {
        PointHierarchyDwr.getPointHierarchy($get("scopeId"),initCB);
    ...
    function save() {
        ...
        hide("folderEditDiv");
        var tree = dojo.widget.manager.getWidgetById('tree');
        var rootFolder = { id: 0, name: "root",scopeId: $get("scopeId"), subfolders: new Array(), points: new Array() };
      ...
      <td valign="top">
        <div class="borderDivPadded">
          <table width="100%">
            ...
            <tr><td class="formError" id="errorMessage"><input type="hidden" id="scopeId" value="${sessionUser.currentScope.id}"></td></tr>
          </table>
