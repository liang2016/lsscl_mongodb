...
abstract public class ViewComponent implements Serializable, JsonSerializable {
    ...
    public static List<ImplDefinition> getImplementations() {
        if (DEFINITIONS == null) {
         ...
         //   d.add(WirelessTempHumSensor.DEFINITION);
            ...
            d.add(FlashPointComponent.DEFINITION);
            //20131114
            d.add(FlashReportPointComponent.DEFINITION);
            DEFINITIONS = d;
        }
    ...
    static Class<? extends ViewComponent> resolveClass(ImplDefinition def) {
        ...
        if (def == FlashPointComponent.DEFINITION)
        	return FlashPointComponent.class;
        if (def == FlashReportPointComponent.DEFINITION)
        	return FlashReportPointComponent.class;
