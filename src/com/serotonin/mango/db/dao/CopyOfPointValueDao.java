...
public class CopyOfPointValueDao extends BaseDao {
...
//	private static final String POINT_VALUE_INSERT_VALUES = "(?,?,?,?)";
	...
	public CopyOfPointValueDao() {
		super();
	}

	public CopyOfPointValueDao(DataSource dataSource) {
		super(dataSource);
	}
...
//??????
	...
	static class BatchWriteBehind implements WorkItem {
		private static final ObjectQueue<BatchWriteBehindEntry> ENTRIES = new ObjectQueue<CopyOfPointValueDao.BatchWriteBehindEntry>();
