...
<table width="100%"  cellspacing="0" cellpadding="0" border="0">
	<tr  style="background-color: #6ba53a">
		<td colspan="3" align="left"><img alt="kpsLogo" width="272px;" height="100px;" src="logos/shouli.png"></img></td>
	</tr>
	<tr>
		...
		<td align="left" style="background-color: #6ba53a"  height="84px"><b><span style="color:#ffffff;font-size: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="login.huawei.word"/></span></b></td>
	</tr>
...
<center>
        <form  action="huawei_login.htm" id="loginForm" method="post"  onSubmit="return true" >
          <table align="center">
