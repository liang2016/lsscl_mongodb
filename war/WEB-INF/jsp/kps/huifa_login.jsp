...
<table width="100%"  cellspacing="0" cellpadding="0" border="0">
	<tr  style="background-color: #6ba53a">
		<td colspan="3" align="left"><img alt="kpsLogo" src="logos/huifajixie.png"></img> </td>
	</tr>
	<tr style="background-color: #6ba53a">
		<td colspan="3" align="center"  style="height: 120px">
			<b><span style="color:#ffffff;font-size: 40px;">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="login.huifajixie.word"/></span></b>
		</td>
	</tr>
	<tr style="background-color: #6ba53a">
...
<center>
        <form  action="huifajixie_login.htm" id="loginForm" method="post"  onSubmit="return true" >
          <table align="center">
...
<table align="center">
   ...
   <tr>
   	<td align="center" height="60px"><span style="color: #006400;font-size: 18px; padding: 10px;" ><fmt:message key="login.huifajixie.tel"/></span></td>
   </tr>
</table>
</body>  
</tag:page>