    ...
    <script type="text/javascript">
      ...
      */
      ...
      function createReport() {
    	  if(!${sessionUser.homeScope.scopetype==0&&sessionUser.admin})
              alert("<fmt:message key="common.no.permissions"/>");//
          else
          	window.location = "reports.shtm?wlid="+ $get("watchListSelect")+"&factoryId=${sessionUser.currentScope.id}";
        	 }
    </script>
                    ...
                    <table cellpadding="0" cellspacing="0" class="rowIcons">
                      <tr>
                        <td onmouseover="mango.view.showChange('p'+ getMangoId(this) +'Change', 4, 12);"
                        	...
                        	<div id="p_TEMPLATE_Change" class="labelDiv" style="visibility:hidden;top:10px;left:1px;" onmouseout="hideLayer(this);">
                        ...
                        <td id="p_TEMPLATE_ChartMin" style="display:none;" onmouseover="showChart(getMangoId(this), event, this);"
                             ...
                             <div id="p_TEMPLATE_ChartLayer" class="labelDiv" style="visibility:hidden;top:0;left:0;"></div>
                  ...
                  <table>
	                  <tr>
	                    ...
	                    <tag:img png="icon_comp" title="watchlist.pointDetails"
	                            onclick="window.location='data_point_details.shtm?dpid='+ getMangoId(this)+'&factoryId=${sessionUser.currentScope.id}'"/>
	                    </td>
	                    <td> 
